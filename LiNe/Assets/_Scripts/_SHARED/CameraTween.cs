...
public class CameraTween
{
    ...
    public LTDescr Size(float to, float time) => LeanTween.value(_camera.orthographicSize, to, time).setIgnoreTimeScale(true).setOnUpdate((value) => { _camera.orthographicSize = value; });
